...
(function () {
  ...
  const DICT = {
    hu: {
      ...
      orders_search_ph: "Keresés (státusz, dátum)...",
      ...
      admin_prod_stock_ph: "pl. 10",      nav_orders: "Rendeléseim",
      orders_table_date: "Dátum",
      orders_table_status: "Státusz",
      orders_table_total: "Összeg",
      orders_table_payment: "Fizetés",
      orders_table_action: "Művelet",
      order_details_title: "Rendelés részletei",
      order_details_status: "Státusz",
      order_details_payment: "Fizetés",
      order_details_total: "Összeg",
      order_details_items: "Tételek",
      order_details_name: "Név",
      order_details_qty: "Mennyiség",
      order_details_price: "Ár",
},
    en: {
      lang_label: "Language",
      ...
      orders_search_ph: "Search (status, date)...",
      ...
      admin_prod_stock_ph: "e.g. 10",      nav_orders: "My orders",
    ...
    de: {
      ...
      orders_search_ph: "Suche (Status, Datum)...",
      ...
      admin_prod_stock_ph: "z.B. 10",      nav_orders: "Meine Bestellungen",
      orders_table_date: "Datum",
      orders_table_status: "Status",
      orders_table_total: "Summe",
      orders_table_payment: "Zahlung",
      orders_table_action: "Aktion",
      order_details_title: "Bestelldetails",
      order_details_status: "Status",
      order_details_payment: "Zahlung",
      order_details_total: "Summe",
      order_details_items: "Positionen",
      order_details_name: "Name",
      order_details_qty: "Menge",
      order_details_price: "Preis",
},
  };
